...
export default function ParrotBird(){

    const [lat, setLat] = useState(23.6171681860513)
    const [lon, setLon] = useState(58.02509693430787)
                            ...
                            <Row className="justify-content-center mt-5">
                                ...
                                style={{ 
                                    ...
                                    <div className="d-flex align-items-center gap-4 flex-wrap">
                                        ...
                                        <div>
                                            <h3>Rio</h3><br/>
                                            <h5>Breed : Parrot Bird </h5>
                                            <h5>Age : 20 yrs</h5>
                                            <h5>Location : Pet Palace Halban</h5>
                                        </div>
