...
export default function FlamingoBird(){

    const [lat, setLat] = useState(23.275920424954766)
    const [lon, setLon] = useState(58.91626993810761)
                            ...
                            <Row className="justify-content-center mt-5">
                                ...
                                style={{ 
                                    ...
                                    <div className="d-flex align-items-center gap-4 flex-wrap">
                                        ...
                                        {/* CAT INFO */}
                                        <div>
                                            <h3>Marshmallow</h3><br/>
                                            <h5>Breed : Flamingo Bird </h5>
                                            <h5>Age : 12 yrs</h5>
                                            <h5>Location : Flamingo lake Qurayyat</h5>
                                        </div>
