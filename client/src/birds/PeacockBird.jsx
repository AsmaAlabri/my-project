...
export default function PeacockBird(){

    const [lat, setLat] = useState(22.64162533613653)
    const [lon, setLon] = useState(58.57565523755695)
                            ...
                            <Row className="justify-content-center mt-5">
                                ...
                                style={{ 
                                    ...
                                    <div className="d-flex align-items-center gap-4 flex-wrap">
                                        ...
                                        <div>
                                            <h3>Aurora</h3><br/>
                                            <h5>Breed : Peacock Bird </h5>
                                            <h5>Age : 11 yrs</h5>
                                            <h5>Location : Safari World Ibra</h5>
                                        </div>
