...
>
    ...
    >
        Discover loyal companions ready to join your family 
    </p>
</div>
...
<Row className="justify-content-center mt-5" key={dog._id}>
    ...
    >
        ...
        <div className="d-flex align-items-center gap-4 flex-wrap">
            ...
            <div>
                ...
                <h5>Age : {dog.age} yrs</h5>

                <h5>Location : {dog.city}</h5>
        ...
        <div className="mt-4">
            ...
            <iframe
                src={`https://maps.google.com/maps?q=${dog.latitude},${dog.longitude}&output=embed`}
                width="100%"
                height="450"
                style={{
                    borderRadius: "15px",
