...
export default function GoldenDog(){

    const [lat, setLat] = useState(23.622045436952686)
    const [lon, setLon] = useState(58.261948120918156)
                    ...
                    <Row className="justify-content-center mt-5">
                        ...
                        style={{ 
                            ...
                            <div className="d-flex align-items-center gap-4 flex-wrap">
                                ...
                                <div>
                                    <h3>Daisy</h3><br/>
                                    <h5>Breed : Golden Retriever</h5>
                                    <h5>Age : 5 yrs</h5>
                                    <h5>Location : Pethouse Al-Mouj</h5>
                                </div>
