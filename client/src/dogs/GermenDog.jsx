...
export default function GermenDog(){

    const [lat, setLat] = useState(23.614448569254073)
    const [lon, setLon] = useState(58.473923608382094)
                    ...
                    <Row className="justify-content-center mt-5">
                        ...
                        style={{ 
                            ...
                            <div className="d-flex align-items-center gap-4 flex-wrap">
                                ...
                                <div>
                                    <h3>Max</h3><br/>
                                    <h5>Breed : German Shepherd</h5>
                                    <h5>Age : 7 yrs</h5>
                                    <h5>Location : Petland Al-Khuwair</h5>
                                </div>
